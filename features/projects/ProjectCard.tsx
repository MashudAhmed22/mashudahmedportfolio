...
export function ProjectCard({ name, tagline, description, tech, icon: Icon, accent, link }: Project) {
  ...
  return (
    <Wrapper {...wrapperProps} className="block h-full">
      <Card className="group relative overflow-hidden bg-card border-foreground/10 hover:border-fuchsia-500/40 transition-all duration-300 hover:-translate-y-1 h-full">
